...
apply-cmvn --utt2spk=ark:data/test/utt2spk \
    ...
    transform-feats pretrained/final.mat ark:- ark:data/test/transform-feats.ark

########################################
# decode
gmm-latgen-faster --max-active=7000 --beam=11.0 --lattice-beam=6.0 \
    ...
    "ark,s,cs:data/test/transform-feats.ark" \
